...
// File: node_modules\@openzeppelin\upgrades\contracts\upgradeability\InitializableUpgradeabilityProxy.sol
...
// File: node_modules\@openzeppelin\upgrades\contracts\upgradeability\InitializableAdminUpgradeabilityProxy.sol
...
contract InitializableAdminUpgradeabilityProxy is BaseAdminUpgradeabilityProxy, InitializableUpgradeabilityProxy {
  ...
  function _willFallback() override(BaseAdminUpgradeabilityProxy, Proxy) internal {
    require(msg.sender != _admin(), "Cannot call fallback function from the proxy admin");
    super._willFallback();
  }
}

// File: node_modules\@openzeppelin\upgrades\contracts\cryptography\ECDSA.sol
...
// File: node_modules\@openzeppelin\upgrades\contracts\upgradeability\ProxyFactory.sol
